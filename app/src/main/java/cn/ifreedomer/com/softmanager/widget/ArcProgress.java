...
import cn.ifreedomer.com.softmanager.util.DimenUtil;
...
public class ArcProgress extends View {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = DimenUtil.sp2px(getResources(), 18);
        min_size = (int) DimenUtil.dp2px(getResources(), 100);
        default_text_size = DimenUtil.sp2px(getResources(), 40);
        default_suffix_text_size = DimenUtil.sp2px(getResources(), 15);
        default_suffix_padding = DimenUtil.dp2px(getResources(), 4);
        default_suffix_text = "%";
        default_bottom_text_size = DimenUtil.sp2px(getResources(), 10);
        default_stroke_width = DimenUtil.dp2px(getResources(), 4);
